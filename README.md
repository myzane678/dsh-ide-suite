...
[![Version](https://img.shields.io/badge/version-1.4.2-blue)](https://github.com/myzane678/dsh-ide-suite/releases)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Node](https://img.shields.io/badge/node-%3E%3D22-green)](https://nodejs.org)
[![pnpm](https://img.shields.io/badge/pnpm-%3E%3D11-orange)](https://pnpm.io)
[![Tests](https://img.shields.io/badge/tests-142%20passed-brightgreen)](#开发)

DSH（DeepSeek Harness）Web GUI 的 IDE 插件套件（monorepo，pnpm workspace）：**编辑器外壳 + LSP 基础设施 + 六语言插件**。v1.4.2——补全框底部预留空间（对齐 VS Code scrollBeyondLastLine）+ 修复「运行后鼠标点不动光标」偶发 bug。新增一种语言的 LSP 支持 = 新增一个插件，编辑器零改动。
...
{
  "dependencies": {
    "dsh-ide-layout": "github:myzane678/dsh-ide-suite#v1.4.2",
    "dsh-lsp-core": "github:myzane678/dsh-ide-suite#v1.4.2",
    "dsh-lsp-python": "github:myzane678/dsh-ide-suite#v1.4.2",
    "dsh-lsp-typescript": "github:myzane678/dsh-ide-suite#v1.4.2",
    "dsh-lsp-java": "github:myzane678/dsh-ide-suite#v1.4.2",
    "dsh-lsp-rust": "github:myzane678/dsh-ide-suite#v1.4.2",
...
见 [CHANGELOG.md](CHANGELOG.md)——v0.1.0 → v1.4.2 逐版记录（v0.x 为 `dsh-ide-layout` 并入前历史）。各子包明细见其各自 CHANGELOG。
