...
[![Version](https://img.shields.io/badge/version-1.2.0-blue)](https://github.com/myzane678/dsh-ide-suite/releases)
...
DSH（DeepSeek Harness）Web GUI 的 IDE 插件套件（monorepo，pnpm workspace）：**编辑器外壳 + LSP 基础设施 + 六语言插件**。v1.2.0——编辑器右键「重启 LSP 连接」+ 补全/签名提示交互打磨。新增一种语言的 LSP 支持 = 新增一个插件，编辑器零改动。
...
{
  "dependencies": {
    "dsh-ide-layout": "github:myzane678/dsh-ide-suite#v1.2.0",
    "dsh-lsp-core": "github:myzane678/dsh-ide-suite#v1.2.0",
    "dsh-lsp-python": "github:myzane678/dsh-ide-suite#v1.2.0",
    "dsh-lsp-typescript": "github:myzane678/dsh-ide-suite#v1.2.0",
    "dsh-lsp-java": "github:myzane678/dsh-ide-suite#v1.2.0",
    "dsh-lsp-rust": "github:myzane678/dsh-ide-suite#v1.2.0",
...
见 [CHANGELOG.md](CHANGELOG.md)——v0.1.0 → v1.2.0 逐版记录（v0.x 为 `dsh-ide-layout` 并入前历史）。各子包明细见其各自 CHANGELOG。
